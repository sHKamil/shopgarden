                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="vivodeship" type="vivodeship" class="form-control @error('vivodeship') is-invalid @enderror" name="vivodeship" value="{{ old('vivodeship') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="street" type="street" class="form-control @error('street') is-invalid @enderror" name="street" value="{{ old('street') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="h_number" type="h_number" class="form-control @error('h_number') is-invalid @enderror" name="h_number" value="{{ old('h_number') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="apartment" type="apartment" class="form-control @error('apartment') is-invalid @enderror" name="apartment" value="{{ old('apartment') }}">
